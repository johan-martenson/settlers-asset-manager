...
public class MapBobsLst {
    ...
    static final int RABBIT_WALKING_EAST_ANIMATION = 525;
    static final int STAG_WALKING_EAST_ANIMATION = 644;
    static final int SHEEP_WALKING_EAST_ANIMATION = 818;
    static final int ICE_BEAR_WALKING_EAST_ANIMATION = 475;
    static final int DEER_2_WALKING_EAST_ANIMATION = 761;
    static final int DUCK_EAST = 754;
