...
public class RomYLst {
    ...
    static final int HEADQUARTER_INDEX = 60;
    static final int BARRACKS_INDEX = 63;
    static final int GUARDHOUSE_INDEX = 68;
    static final int WATCHTOWER_INDEX = 73;
    static final int FORTRESS_INDEX = 78;
    static final int GRANITE_MINE_INDEX = 83;
    static final int COAL_MINE_INDEX = 87;
    static final int IRON_MINE_RESOURCE = 91;
    static final int GOLD_MINE_INDEX = 95;
    static final int LOOKOUT_TOWER_INDEX = 99;
    static final int CATAPULT_INDEX = 104;
    static final int WOODCUTTER_INDEX = 108;
    static final int FISHERY_INDEX = 113;
    static final int QUARRY_INDEX = 118;
    static final int FORESTER_HUT_INDEX = 123;
    static final int SLAUGHTER_HOUSE_INDEX = 128;
    static final int HUNTER_HUT_INDEX = 133;
    static final int BREWERY_INDEX = 138;
    static final int ARMORY_INDEX = 143;
    static final int METALWORKS_INDEX = 148;
    static final int IRON_SMELTER_INDEX = 153;
    static final int PIG_FARM_INDEX = 158;
    static final int STOREHOUSE_INDEX = 163;
    static final int MILL_NO_FAN_INDEX = 168;
    static final int BAKERY_INDEX = 173;
    static final int SAWMILL_INDEX = 178;
    static final int MINT_INDEX = 183;
    static final int WELL_INDEX = 188;
    static final int SHIPYARD_INDEX = 193;
    static final int FARM_INDEX = 198;
    static final int DONKEY_BREEDER_INDEX = 203;
    static final int HARBOR_INDEX = 208;
    static final int CONSTRUCTION_PLANNED_INDEX = 212;
